        ...
        <div class="content">
            ...
            <form method="POST" action="{{ route('offer.update',$offer->id) }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name_ar" id="exampleInputEmail1" value="{{$offer->name_ar}}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name_en" id="exampleInputEmail1" value="{{$offer->name_en}}"
                        aria-describedby="emailHelp" placeholder="{{__('message.offer name')}}">
                    @error('name_en')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="price" id="exampleInputPassword1" value="{{$offer->price}}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="details_ar" id="exampleInputPassword1" 
                            value="{{$offer->details_ar}}" placeholder="{{__("message.offer details")}}">
                    @error('details_ar')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    value="{{$offer->details_en}}" placeholder="{{__("message.offer details")}}">
                    @error('details_en')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
